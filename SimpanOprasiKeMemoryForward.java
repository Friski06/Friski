...
/**
 * Write a description of interface SimpanOprasiKeMemoryForward here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class SimpanOprasiKeMemoryForward implements SimpanCalculator{
    private String[] dataMemori = new String[10];
    private int pointer = 0;
    private String tampilMemori;
    
    public SimpanOprasiKeMemoryForward()
    {
